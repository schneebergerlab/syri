...
if __name__ == "__main__":
    ...
    parser.add_argument("coords", type=argparse.FileType("r"))
    parser.add_argument("ref", type=argparse.FileType("r"))
    parser.add_argument("qry", type=argparse.FileType("r"))
    ...
    parser.add_argument('-noref', dest='noref', help="Use this parameter when no assembly is at chromosome level", defaul=False, action='store_true')
